...
/help - краткая инструкция по поключению
@wolf0vpn_help_bot - по всем повросам и пожеланиям.
...
Если же у вас возникли вопросы или что-то не получается, то вот тут находится более подробная инструкция.
